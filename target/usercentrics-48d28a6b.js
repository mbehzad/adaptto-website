 ...
 */
function decorateWithConsent(service, parent, decorator) {
 ...
 */
function decorateConsentManagement(head) {
...
export { decorateWithConsent as a, decorateConsentManagement as d };
