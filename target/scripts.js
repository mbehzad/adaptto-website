function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    ...
    case '../blocks/embed-pretix/embed-pretix.js': return import('./embed-pretix-49098ad5.js');
    case '../blocks/embed-youtube/embed-youtube.js': return import('./embed-youtube-0799ed12.js');
    case '../blocks/footer/footer.js': return import('./footer-8c885ac7.js');
    case '../blocks/fragment/fragment.js': return import('./fragment-66859ac7.js');
    case '../blocks/header/header.js': return import('./header-ed2dba42.js');
    case '../blocks/image-gallery/image-gallery.js': return import('./image-gallery-0507a7bc.js');
    case '../blocks/schedule/schedule.js': return import('./schedule-22f16c45.js');
    case '../blocks/social-teaser/social-teaser.js': return import('./social-teaser-4ed993c7.js');
    case '../blocks/speaker-detail/speaker-detail.js': return import('./speaker-detail-db9d7a9e.js');
    case '../blocks/speaker-gallery/speaker-gallery.js': return import('./speaker-gallery-b9848322.js');
    case '../blocks/sponsor-teaser/sponsor-teaser.js': return import('./sponsor-teaser-4ed993c7.js');
    case '../blocks/stage-header/stage-header.js': return import('./stage-header-d25e7062.js');
    case '../blocks/talk-archive/talk-archive.js': return import('./talk-archive-5894acaf.js');
    case '../blocks/talk-detail-after-outline/talk-detail-after-outline.js': return import('./talk-detail-after-outline-a02d93d7.js');
    case '../blocks/talk-detail-before-outline/talk-detail-before-outline.js': return import('./talk-detail-before-outline-0ca96803.js');
    case '../blocks/talk-detail-footer/talk-detail-footer.js': return import('./talk-detail-footer-a7eb36d0.js');
  ...
  if (status !== 'loading' && status !== 'loaded') {
    ...
    try {
      ...
      const decorationComplete = new Promise((resolve) => {
        (async () => {
          try {
            const mod = await __variableDynamicImportRuntime0__(`../blocks/${blockName}/${blockName}.js`);
            if (mod.default) {
...
function loadDelayed() {
  ...
  window.setTimeout(() => import('./delayed-1d526ca7.js'), 3000);
